...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://fast-food-rn0a59qco-chaman3s-projects.vercel.app/api/auth/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://fast-food-rn0a59qco-chaman3s-projects.vercel.app/api/auth/createuser", {
      // credentials: 'include',
